...
class ModeloUsuarios
{
	...
	static public function mdlIngresarUsuario($tabla, $datos)
	{
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre, usuario, password, perfil, foto, estado, documento_identidad) VALUES (:nombre, :usuario, :password, :perfil, :foto, :estado, :documento_identidad)");
