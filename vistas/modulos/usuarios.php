        ...
        <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
          ...
          <tbody>
            ...
            foreach ($usuarios as $key => $value) {
              ...
              if ($value["documento_identidad"] != "") {

                echo '<td>' . $value["documento_identidad"] . '</td>';
              } else {
                echo '<td>No tiene documento de identidad</td>';
              }
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="documentoIdentidad" placeholder="Ingresar documento de identidad" required>
